...
"""
    ...
    def _get_volttron_system_prompt(self):
        ...
        return (
            ...
            "- **IMPORTANT**: When user says 'I don't know', 'nothing to add', 'don't have anything', 'no more', 'leave blank', or similar:\n"
            "  → Call agent_creator_next_step_tool with EMPTY STRING \"\" to skip/continue\n"
            "  → Do NOT pass the user's text - pass \"\" to advance the wizard\n"
            "  → For URL step: empty string skips URL analysis\n"
            "  → For topics/dependencies: empty string means done adding items\n\n"
            "TOOLS AVAILABLE:\n"
